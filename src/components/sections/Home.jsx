        ...
        <section
            ...
            <RevealOnScroll>
                ...
                <div className="text-center z-10 px-4">
                    ...
                    <h1 className="text-5xl md-7xl font-bold mb-6 bg-gradient-to-r from-blue-500 to-cyan-400 bg-clip-text text-transparent leading-right">
                        Hi, I'm Paul-Emmanuel
                    </h1>
                    ...
                    <div className = "flex justify-center space-x-4">
                        ...
                        hover:-translate-y-0.5 hover:shadow-[0_0_15px_rgba(59, 130, 236, 0.4)]
                        ">
                            View Projects
                        </a>
